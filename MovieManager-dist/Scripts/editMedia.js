...
function ConfigureEditModal() {
    document.querySelector("#edit-media-modal").addEventListener('hidden.bs.modal', function () {
        ResetModal();
    });
    document.querySelector("#editMediaForm").addEventListener('submit', ResetModal());
}
...
function AddGenre() {
    ...
    pillContainer.classList.add("mt-2", "d-block");

    var pill = document.createElement("span");
    pill.classList.add("alert", "alert-secondary", "p-2", "mr-2", "me-2", "d-block");
...
`
    ...
    labelContainer.append(pillContainer);
